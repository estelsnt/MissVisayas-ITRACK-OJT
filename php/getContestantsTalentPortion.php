<?php
     ...
     $query = "SELECT 
                ...
                contestants.fullname,
                    ...
                    AND mv_scores.sub_event_name = 'talentportion') AS 'avgTalentPortionScore',
                    ...
                    WHERE mv_scores.contestant_id = contestants.contestant_id 
                    AND mv_scores.sub_event_name = 'talentportion'
                    AND mv_scores.judge_id = ".$_SESSION['judgeID'].") AS 'talentPortionScore'
                FROM contestants
                ...
                ORDER BY totalTalentPortionScore DESC;";
    ...
    if($result->num_rows > 0){
        while($row = $result->fetch_assoc()){
            array_push($d, array(
                ...
                'avgTalentPortionScore' => $row['avgTalentPortionScore'],
                'totalTalentPortionScore' => $row['totalTalentPortionScore'],
                'talentPortionScore' => $row['talentPortionScore']
            ));
        }
        echo json_encode($d);
    }else{
